    ...
    private static class BarBackgroundDrawable extends Drawable {
        ...
        public BarBackgroundDrawable(Context context, int gradientResourceId) {
            ...
            if (DEBUG_COLORS) {
                ...
                mOpaque = context.getResources().getColor(R.color.system_bar_background_opaque);
                mSemiTransparent = context.getResources().getColor(
                        R.color.system_bar_background_semi_transparent);
                mTransparent = context.getResources().getColor(R.color.system_bar_background_transparent);
                mWarning = context.getResources().getColor(R.color.battery_saver_mode_color);
            }
        ...
        public void setTint(int color) {
            if (mTintFilter == null) {
                ...
                try {
                    Method setColor = PorterDuffColorFilter.class.getDeclaredMethod(
                            "setColor", int.class
                    );
                    setColor.invoke(mTintFilter, color);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        public void setTintMode(Mode tintMode) {
            if (mTintFilter == null) {
                ...
                try {
                    Method setMode = PorterDuffColorFilter.class.getDeclaredMethod(
                            "setMode", PorterDuff.Mode.class
                    );
                    setMode.invoke(mTintFilter, tintMode);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
